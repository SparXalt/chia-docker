...
RUN git clone --branch main https://github.com/Shamrock-Network/shamrock-blockchain.git \
&& cd shamrock-blockchain \
&& git submodule update --init mozilla-ca \
&& chmod +x install.sh \
&& /usr/bin/sh ./install.sh

ENV PATH=/shamrock-blockchain/venv/bin/:$PATH
WORKDIR /shamrock-blockchain
